...
class Form extends Component {
  state = {
    ...
    charge: this.props.data.contact.charge || '',
    occupation: this.props.data.contact.occupation || '',
    birth_date: this.props.data.contact.birth_date || Date.now(),
    email: this.props.data.contact.email || '',
    alt_email: this.props.data.contact.alt_email || '',
    phone: this.props.data.contact.phone || '',
    cellphone: this.props.data.contact.cellphone || '',
    subscribed: this.props.data.contact.subscribed || false,
    observations: this.props.data.contact.observations || '',
    volunteer: this.props.data.contact.volunteer || false,
    account: this.props.data.contact.account ? this.props.data.contact.account.name : '',
    origin: this.props.data.contact.origin ? this.props.data.contact.origin.name : '',
    contact_type: this.props.data.contact.contact_type ? this.props.data.contact.contact_type.name : '',
    gender: this.props.data.contact.gender || ''
  }
