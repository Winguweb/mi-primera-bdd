const Searchbar = () => (
  <div className="w-2/5">
    <div className="relative mr-6 my-2">
      <input type="search" className="w-full bg-purple-white shadow rounded border-0 py-3 px-12" placeholder="Buscar..." />
      <div className="absolute top-0 left-0 mt-4 ml-4 text-purple-lighter">
        <svg version="1.1" className="h-4 text-dark" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
          viewBox="0 0 52.966 52.966" style={{'enable-background':'new 0 0 52.966 52.966'}} xmlSpace="preserve">
